...
- **PR** `#19570`_: (*basepi*) Fix some logging issues for cmd.run with quiet *( references: `#19479`_ )*
...
- **PR** `#19590`_: (*basepi*) Always return True from supervisord virtual function *( references: `#18044`_ )*
...
- **PR** `#19155`_: (*techhat*) Allow service_name to be specified for azure *( references: `#15959`_ )*
...
- **PR** `#19552`_: (*terminalmage*) Fix regression in masterless pillar generation *( references: `#19540`_ )*
...
- **PR** `#19344`_: (*RobertFach*) Svn export fix issue 19343 *( references: `#19343`_ )*
...
- **PR** `#19551`_: (*cachedout*) Release note note *( references: `#18551`_ )*
...
- **PR** `#19521`_: (*thatch45*) Merge `#19493`_ *( references: `#19493`_ )*
...
- **PR** `#19247`_: (*Nikerabbit*) Fix execution order with "names" in relation to other states *( references: `#13312`_ )*
...
- **PR** `#19354`_: (*cachedout*) Avoid a race between multiple auth requests for a minion key *( references: `#19061`_ )*
...
- **PR** `#18323`_: (*techhat*) Use proper query method from CloudClient *( references: `#18320`_ )*
...
- **PR** `#19378`_: (*llinder*) Fixed undefined data variable in s3 utils *( references: `#19376`_ )*
...
- **PR** `#19350`_: (*UtahDave*) Fix thread leak on Windows when using threading. *( references: `#18515`_ `#19167`_ )*
...
- **ISSUE** `#18630`_: (*nvx*) Forced remount because options changed when no options changed (2014.7 regression)
- **PR** `#19319`_: (*garethgreenaway*) Fixes to mount module and mount state module *( references: `#19308`_ `#18630`_ )*
...
- **PR** `#19312`_: (*llinder*) pydsl/pyobjects missing listen and listen_in *( references: `#19311`_ )*
...
- **PR** `#19310`_: (*timoguin*) Fix typo in Tomcat module docs *( references: `#19300`_ )*
...
- **PR** `#19321`_: (*cvedel*) Add ssl_match_hostname to deps in thin tarball *( references: `#18083`_ )*
...
- **PR** `#19153`_: (*rallytime*) Update the windows package to correct one: 2014.7.0 --> 2014.7.0-1 *( references: `#19146`_ )*
...
- **PR** `#18915`_: (*babilen*) Ensure aptpkg._consolidate_repo strips trailing slashes from repo_uri *( references: `#18909`_ )*
...
- **PR** `#19104`_: (*whiteinge*) Used unused variable; fix highstate output for jobs runner *( references: `#19099`_ )*
...
- **PR** `#19113`_: (*garethgreenaway*) Fixes for when using bind mounts. *( references: `#19003`_ )*
...
- **PR** `#19065`_: (*basepi*) Fix salt-ssh with sudo and tty enabled *( references: `#16847`_ )*
...
- **PR** `#18615`_: (*eliasp*) Don't change a file again if it's already been done. *( references: `#18612`_ )*
...
- **PR** `#19062`_: (*terminalmage*) Fix traceback for non-string values in lxc config files *( references: `#19055`_ )*
...
- **PR** `#18254`_: (*jacksontj*) Move reactor master-clients to threads *( references: `#16564`_ )*
...
- **PR** `#19059`_: (*rallytime*) Correct master_sign_key_name reference *( references: `#19057`_ )*
...
- **PR** `#19019`_: (*jacksontj*) Backport `#19012`_ to 2014.7 *( references: `#19012`_ )*
...
- **PR** `#18996`_: (*garethgreenaway*) schedule.list should return an empty dictionary, not None *( references: `#18969`_ )*
...
- **PR** `#18978`_: (*garethgreenaway*) fixes to mount for nfs share *( references: `#18907`_ )*
...
- **PR** `#18972`_: (*garethgreenaway*) Fixes to mount module *( references: `#18874`_ )*
...
- **PR** `#18968`_: (*s0undt3ch*) The `gpgkeys` path should use `salt.syspaths` *( references: `#18877`_ )*
...
- **PR** `#18924`_: (*cro*) Fix bad option handling for FreeBSD pkgng. *( references: `#18851`_ )*
...
- **PR** `#18897`_: (*UtahDave*) Use Salt defined exit codes. *( references: `#18244`_ )*
...
- **PR** `#18894`_: (*cro*) Add support for sockstat on FreeBSD as an alternative to lsof *( references: `#18584`_ )*
...
- **PR** `#18213`_: (*sumso*) Update sqlite3.py to enable autocommit *( references: `#18152`_ )*
...
- **PR** `#18876`_: (*garethgreenaway*) fixes to iptables module *( references: `#17185`_ )*
...
- **PR** `#18889`_: (*thatch45*) Merge `#18871`_ *( references: `#18871`_ )*
...
- **PR** `#18864`_: (*techhat*) Run disk.inodeusage in posix mode *( references: `#18862`_ )*
...
- **PR** `#18814`_: (*eliasp*) 2014.7 eselect improvements *( references: `#18783`_ )*
...
- **PR** `#18812`_: (*cro*) Fix logic error introduced sometime in the past 6 months that prevented ... *( references: `#18799`_ )*
...
- **PR** `#18804`_: (*garethgreenaway*) fixes to debian_ip.py *( references: `#12178`_ )*
...
- **PR** `#18782`_: (*rallytime*) Fix markup so master_tops document will render correctly *( references: `#18723`_ )*
...
- **PR** `#18780`_: (*rallytime*) Add pymongo requirement notification to mongodb_user state *( references: `#18756`_ )*
...
- **PR** `#18767`_: (*garethgreenaway*) Fixes to mount state. *( references: `#18474`_ )*
...
- **PR** `#18739`_: (*cachedout*) Job to clean pub auth *( references: `#18736`_ )*
...
- **PR** `#18728`_: (*rallytime*) Remove space between salt.utils.process. and ThreadPool *( references: `#18707`_ )*
...
- **PR** `#18666`_: (*garethgreenaway*) Fixed to mount state related to enabling swap *( references: `#18550`_ )*
...
- **PR** `#18660`_: (*garethgreenaway*) Fixes to mount state. *( references: `#18613`_ )*
...
- **PR** `#18654`_: (*thatch45*) Add retcode and success to function not found *( references: `#18512`_ )*
...
- **PR** `#18644`_: (*rallytime*) If the asg does not exist in the region provided, don't return True. *( references: `#18566`_ )*
...
- **PR** `#18682`_: (*eliasp*) Don't empty the file when it is supposed to be only read. *( references: `#18680`_ )*
...
- **PR** `#18592`_: (*nazgul5*) salt.utils.network._interfaces_ifconfig: SunOS fix *( references: `#18591`_ )*
...
- **PR** `#18610`_: (*rallytime*) Make ZMQ 4 installation docs for ubuntu more clear *( references: `#18476`_ )*
...
- **PR** `#18577`_: (*garethgreenaway*) Fixes to scheduler in 2014.7 *( references: `#18534`_ )*
...
- **PR** `#18568`_: (*terminalmage*) Fix yum pkg holding when doing version pinning with "pkgs" arg *( references: `#18468`_ )*
...
- **PR** `#18526`_: (*amendlik*) Saltmod cmd all output *( references: `#18511`_ )*
...
- **PR** `#18494`_: (*rallytime*) Clean up doc build so it doesn't stacktrace *( references: `#18471`_ )*
...
- **PR** `#18485`_: (*cachedout*) Do not log *( references: `#18453`_ )*
...
- **PR** `#18467`_: (*rallytime*) Remove encoding kwarg from ustring *( references: `#18458`_ )*
- **PR** `#18374`_: (*thatch45*) Add new sdecode to nested outputter *( references: `#18053`_ )*
...
- **PR** `#18449`_: (*cachedout*) Friendly message if name arg is none/false *( references: `#18432`_ )*
...
- **PR** `#18452`_: (*cachedout*) Pass loglevel in zcbuildout *( references: `#18380`_ )*
...
- **PR** `#18443`_: (*basepi*) Add warning to docs about topfile compilation *( references: `#12483`_ )*
...
- **PR** `#18382`_: (*thatch45*) Add verification of unicode data in windows data sets *( references: `#12255`_ )*
...
- **PR** `#18392`_: (*thatch45*) Check for listen data struct validity *( references: `#18360`_ )*
...
- **PR** `#18389`_: (*rallytime*) Fix unused args in modules/cloud.py *( references: `#18387`_ )*
...
- **PR** `#18385`_: (*rallytime*) Add information about salt-cloud events to master events doc *( references: `#16755`_ )*
...
- **PR** `#18378`_: (*rallytime*) Backport `#18105`_ to 2014.7 *( references: `#18105`_ )*
...
- **PR** `#18375`_: (*rallytime*) Remove 'repo' argument as it isn't used by function *( references: `#18371`_ )*
...
- **PR** `#18376`_: (*thatch45*) Add sdecode for highstate *( references: `#18361`_ )*
...
- **PR** `#18348`_: (*thatch45*) Fix error with perm denial on unpriv job lookups *( references: `#17958`_ )*
...
- **PR** `#18345`_: (*thatch45*) Always extract when extracting *( references: `#18052`_ )*
...
- **PR** `#18333`_: (*whiteinge*) Fix missing space after colon in architecture doc *( references: `#18134`_ )*
...
- **PR** `#18334`_: (*thatch45*) fall back to utf-8 if we get a unicode error *( references: `#18203`_ )*
...
- **PR** `#18277`_: (*thatch45*) fix error where file.recurse would mess up names on salt-ssh *( references: `#17266`_ )*
...
- **PR** `#18291`_: (*thatch45*) Add certifi to the deps in thin tarball *( references: `#16773`_ )*
...
- **PR** `#18207`_: (*thatch45*) Merge `#18196`_ with fixes *( references: `#18196`_ )*
- **PR** `#18196`_: (*kostko*) Fix for pyobjects __salt__ wrapper (SaltObject) *( references: `#18088`_ )*
...
- **PR** `#18186`_: (*whiteinge*) Added nohup example to the FAQ about restarting Salt with Salt *( references: `#7997`_ )*
...
- **PR** `#18119`_: (*kshenk1*) Adds param to def create_attach_volume (wait_to_finish), default to true... *( references: `#18118`_ )*
...
- **PR** `#17952`_: (*opdude*) Cherry picked: Fix salt.utils.chugid group_list filtering on OS X *( references: `#16839`_ )*
...
- **PR** `#17712`_: (*timoguin*) Updated aptpkg.mod_repo() module to properly add new PPAs *( references: `#17709`_ )*
...
- **PR** `#17953`_: (*rallytime*) Fix spelling in raet doc *( references: `#17950`_ )*
...
- **PR** `#17305`_: (*jacksontj*) 2014.7 *( references: `#17299`_ )*
...
- **PR** `#17304`_: (*thatch45*) Merge `#17225`_ *( references: `#17225`_ )*
...
- **PR** `#17277`_: (*s0undt3ch*) Pass the right environ to VT's env. *( references: `#17262`_ `#17263`_ )*
...
- **PR** `#17231`_: (*thatch45*) Merge `#17169`_ *( references: `#17169`_ )*
...
- **PR** `#17156`_: (*cachedout*) Update to new softwareproperties.ppa upstream changes *( references: `#17105`_ )*
...
- **PR** `#16937`_: (*terminalmage*) Force VCS fileserver backend config values to be loaded as strings *( references: `#16285`_ )*
