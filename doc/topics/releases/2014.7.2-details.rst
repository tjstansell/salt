...
- **PR** `#20487`_: (*whiteinge*) Remove Mako from mocked deps for docs build *( references: `#9571`_ )*
...
- **PR** `#20229`_: (*basepi*) Check for terminated (errored) processes in salt-ssh *( references: `#20223`_ )*
...
- **PR** `#20465`_: (*cachedout*) Fix mismatched config value for auth_safemode *( references: `#19945`_ )*
...
- **PR** `#20386`_: (*cachedout*) Don't run cron as a user with -u on Linux *( references: `#19916`_ )*
...
- **PR** `#20430`_: (*kim0*) FreeBSD support for module status .. is done (fixes `#20045`_) *( references: `#20045`_ )*
...
- **PR** `#20389`_: (*jfindlay*) fix pip venv regression, deprecate activate param *( references: `#20191`_ )*
...
- **PR** `#14834`_: (*gtmanfred*) Only assign win_password if it actually is set *( references: `#14808`_ )*
...
- **PR** `#20344`_: (*jfindlay*) allow upper case letters in npm package names *( references: `#20329`_ )*
...
- **PR** `#20412`_: (*rallytime*) Cast ssh_port as an integer to stop stacktrace when provising azure instances *( references: `#20385`_ )*
...
- **PR** `#20390`_: (*basepi*) [2014.7] Fix eauth group authentication (backport of `#20281`_) *( references: `#20281`_ `#17380`_ )*
- **PR** `#20281`_: (*MrMarvin*) fixes a bug which broke eauth with group permissions *( references: `#2215`_ )*
...
- **PR** `#20097`_: (*jfindlay*) fix debian/ubuntu handling in locale.gen_locale *( references: `#18936`_ )*
...
- **ISSUE** `#20223`_: (*basepi*) Salt-ssh hangs when exceptions are thrown
- **PR** `#20261`_: (*thatch45*) Merge `#20229`_ with fixes *( references: `#20229`_ )*
- **PR** `#20229`_: (*basepi*) Check for terminated (errored) processes in salt-ssh *( references: `#20223`_ )*
...
- **PR** `#20218`_: (*felskrone*) improved status.master to work with fqdns *( references: `#19380`_ `#19080`_ )*
...
- **PR** `#20260`_: (*thatch45*) Merge `#20241`_ with fixes *( references: `#20241`_ )*
...
- **PR** `#20225`_: (*jfindlay*) extend a list not a tuple *( references: `#20224`_ )*
...
- **PR** `#20203`_: (*basepi*) [2014.7] Iterate over the shortopts if there are more than one for archive.extracted *( references: `#20195`_ )*
...
- **PR** `#20118`_: (*kitsemets*) salt.states.cmd: fixed 'unless' behaviour in case of multiple commands are given *( references: `#11898`_ `#16044`_ )*
- **PR** `#16044`_: (*rallytime*) Clarify unless and onlyif docs *( references: `#14634`_ )*
- **PR** `#11898`_: (*rallytime*) Onlyif return codes added to debug log *( references: `#11879`_ )*
...
- **PR** `#20163`_: (*jfindlay*) fix sysctl test state comparison *( references: `#20145`_ )*
...
- **PR** `#15701`_: (*Jille*) Fixed the Result of file.replace (`#15417`_) *( references: `#15417`_ )*
...
- **PR** `#20155`_: (*basepi*) Do not use 'is' for string comparison *( references: `#19528`_ )*
...
- **PR** `#20046`_: (*hvnsweeting*) bugfix: persist accumulator data after reload_modules, fix `#8881`_ *( references: `#19731`_ )*
...
- **PR** `#19912`_: (*basepi*) Assume __salt__['config.get'] is present in gpg renderer *( references: `#19114`_ `#19787`_ )*
...
- **PR** `#19968`_: (*jfindlay*) allow user to disable DNS for win net iface *( references: `#18513`_ )*
...
- **PR** `#20015`_: (*basepi*) Fix grains precedence issues *( references: `#19611`_ `#19612`_ )*
...
- **PR** `#18400`_: (*terminalmage*) Fix gitfs serving symlinks *( references: `#17700`_ )*
...
- **PR** `#19959`_: (*RobertFach*) updated information regarding required version for dulwich gitfs backend *( references: `#19875`_ )*
...
- **PR** `#19930`_: (*highlyunavailable*) Split out tar options into long and short array-based arguments *( references: `#19928`_ )*
...
- **PR** `#19927`_: (*jfindlay*) create /etc/sysctl.d/99-salt.conf if not present *( references: `#19870`_ )*
...
- **PR** `#19921`_: (*thatch45*) Merge `#19838`_ *( references: `#19838`_ )*
...
- **PR** `#19902`_: (*jfindlay*) test for blkid before running disk.blkid *( references: `#19795`_ )*
...
- **PR** `#19825`_: (*jfindlay*) remove redundant code, append extra_arguments to cmd *( references: `#19824`_ )*
...
- **PR** `#19820`_: (*highlyunavailable*) Force roots fileclient on Masterless Windows to return fake POSIX/"url" *( references: `#19815`_ )*
...
- **PR** `#19789`_: (*jfindlay*) end /etc/hosts with EOL to not break utils that read it *( references: `#19738`_ )*
...
- **PR** `#19804`_: (*basepi*) Fix for passing pillar to state runs in salt-ssh *( references: `#19773`_ )*
...
- **PR** `#19742`_: (*basepi*) [DO NOT MERGE] Remove msgpack from thin generation for salt-ssh *( references: `#7913`_ )*
...
- **PR** `#19741`_: (*basepi*) Fix FunctionWrapper to allow for jinja salt.cmd.run() syntax *( references: `#19681`_ )*
...
- **PR** `#19698`_: (*basepi*) Force contents to string under Falsey conditions too for file.managed *( references: `#19669`_ )*
...
- **PR** `#19722`_: (*rallytime*) Remove old --out options from salt-cloud docs *( references: `#19453`_ )*
...
- **PR** `#19689`_: (*rallytime*) Add versionadded directives to newer locale functions *( references: `#19607`_ )*
