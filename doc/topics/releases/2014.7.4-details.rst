...
- **PR** `#22074`_: (*borgstrom*) Fix requisites missing from pyobjects that were introduced in 2014.7 *( references: `#20652`_ )*
...
- **PR** `#22020`_: (*UtahDave*) fix bug where can't restart salt-minion *( references: `#21961`_ )*
...
- **PR** `#22022`_: (*garethgreenaway*) more fixes to mount.py state module *( references: `#21992`_ )*
...
- **PR** `#22014`_: (*garethgreenaway*) Fixes to mount.py state module *( references: `#21888`_ )*
