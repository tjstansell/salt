...
- 2015-04-16T19:50:00Z **PR** `#22754`_: (*twangboy*) Removed redundant \\ and "

  * 1fb606e Merge pull request `#22754`_ from twangboy/fix_bat_again
  * 223c46a Removed redundent \\ and "

- 2015-04-16T16:27:31Z **PR** `#22748`_: (*twangboy*) Changed %cd% to %~dp0
...
- 2015-04-16T04:51:02Z **PR** `#22716`_: (*twangboy*) Removed list_pkgs caching
...
- 2015-04-15T05:17:47Z **PR** `#22688`_: (*msteed*) Add missing command line options to man pages
...
- 2015-04-15T04:06:45Z **PR** `#22693`_: (*dmyerscough*) Fixing key error

  * fb31ab4 Merge pull request `#22693`_ from dmyerscough/fix-keyerror-in-salt-cloud
  * f35c3bd Fixing key error

- 2015-04-14T21:42:44Z **PR** `#22674`_: (*jacobhammons*) Regenerated salt-call and salt.7 man pages
...
- 2015-04-14T19:24:03Z **PR** `#22666`_: (*msteed*) Update salt-call manpage to match cli help text
...
- 2015-04-14T18:47:20Z **PR** `#22623`_: (*thatch45*) merge 22115 in correct branch
...
- 2015-04-14T16:50:33Z **PR** `#22656`_: (*jfindlay*) backport `#22624`_ to 2014.7
...
- 2015-04-14T15:30:25Z **PR** `#22643`_: (*TimJones*) Fix aptpkg.mod_repo returning OK even if apt-add-repository fails.
...
- 2015-04-14T14:13:26Z **PR** `#22625`_: (*rallytime*) Backport `#22565`_ to 2014.7
...
- 2015-04-13T21:32:15Z **PR** `#22621`_: (*rallytime*) Add note about missing state internal keyword arguments to release notes
...
- 2015-04-13T21:25:12Z **PR** `#22610`_: (*rallytime*) Add batch matching bug note to known issues in 2014.7.4 release notes
...
- 2015-04-13T21:25:04Z **PR** `#22608`_: (*garethgreenaway*) remount related fixes in 2014.7
...
- 2015-04-13T20:53:39Z **PR** `#22476`_: (*tjstansell*) fix `#21998`_ - use yum reposdir as basedir defaults
...
- 2015-04-13T20:39:52Z **PR** `#22597`_: (*hvnsweeting*) fix `#12480`_
...
- 2015-04-13T20:12:04Z **PR** `#22553`_: (*anlutro*) Make git.latest work with empty source repositories
...
- 2015-04-13T15:09:34Z **PR** `#22576`_: (*batulin-s*) fixed `#22329`_ bug
...
- 2015-04-13T14:20:08Z **PR** `#22584`_: (*msusta*) Fixed malformed locale string in localmod module
...
- 2015-04-11T09:27:13Z **PR** `#22542`_: (*EliRibble*) Show errors on failure to render reactors
...
- 2015-04-10T21:56:09Z **PR** `#22535`_: (*rallytime*) Add additional examples to grains.list_absent and grains.list_present
...
- 2015-04-10T20:25:39Z **PR** `#22532`_: (*rallytime*) Backport `#18846`_ to 2014.7
...
- 2015-04-10T15:57:13Z **PR** `#22484`_: (*EliRibble*) Fix 22472
...
- 2015-04-10T15:56:24Z **PR** `#22521`_: (*anlutro*) Add force argument to service to trigger force_reload
...
- 2015-04-10T15:22:42Z **PR** `#22523`_: (*hvnsweeting*) fix `#20420`_: using other state's comment makes comment grow fast
...
- 2015-04-10T15:19:34Z **PR** `#22511`_: (*The-Loeki*) small enhancement to dnsutil module
...
- 2015-04-10T15:13:17Z **PR** `#22526`_: (*dhs-rec*) Return 0 for good puppet return codes (0 and 2), 1 otherwise

  * d80f258 Merge pull request `#22526`_ from dhs-rec/2014.7
  * 36b9466 Return 0 for good puppet return codes (0 and 2), 1 otherwise

- 2015-04-10T15:11:25Z **PR** `#22464`_: (*jacksontj*) 2014.7: Fix Batching
...
- 2015-04-10T02:50:38Z **PR** `#22517`_: (*s0undt3ch*) Don't assume we're running the tests as root

  * c755463 Merge pull request `#22517`_ from s0undt3ch/2014.7
  * 1181a50 Don't assume we're running the tests as root

- 2015-04-09T19:42:39Z **PR** `#22506`_: (*rallytime*) Backport `#20095`_ to 2014.7
...
- 2015-04-09T13:13:15Z **PR** `#22381`_: (*batulin-s*) fix `#22321`_ bug
...
- 2015-04-09T13:11:36Z **PR** `#22492`_: (*davidjb*) Correctly report disk usage on Windows. Fix `#16508`_
...
- 2015-04-09T04:51:43Z **PR** `#22446`_: (*br0ch0n*) Issue `#20850`_ puppet run should return actual code
...
- 2015-04-08T23:01:37Z **PR** `#22466`_: (*whiteinge*) Updated wording about nested dictionaries in states.file.managed docs
...
- 2015-04-08T22:53:48Z **PR** `#22403`_: (*hvnsweeting*) create host file if it does not exist
...
- 2015-04-08T20:27:05Z **PR** `#22477`_: (*twangboy*) Moved file deletion to happen after user clicks install
...
- 2015-04-08T19:27:37Z **PR** `#22473`_: (*EliRibble*) Add the ability to specify key prefix for S3 ext_pillar
...
- 2015-04-08T18:32:36Z **PR** `#22448`_: (*rallytime*) Migrate old cloud config documentation to own page
...
- 2015-04-08T01:34:55Z **PR** `#22445`_: (*rallytime*) Add docs explaing file_map upload functionality
...
- 2015-04-07T21:42:39Z **PR** `#22426`_: (*jraby*) don't repeat the "if ret['changes']" condition

  * ade2474 Merge pull request `#22426`_ from jraby/patch-1
  * e2aa538 don't repeat the "if ret['changes']" condition

- 2015-04-07T21:19:32Z **PR** `#22416`_: (*rallytime*) Backport `#21044`_ to 2014.7
...
- 2015-04-07T20:36:10Z **PR** `#22433`_: (*rallytime*) Clarify that an sls is not available on a fileserver
...
- 2015-04-07T20:34:57Z **PR** `#22434`_: (*rallytime*) Backport `#22414`_ to 2014.7
...
- 2015-04-07T13:40:09Z **PR** `#22400`_: (*jfindlay*) adding cmd.run state integration tests

  * 28630b4 Merge pull request `#22400`_ from jfindlay/cmd_state_tests
  * 56364ff adding cmd.run state integration tests

- 2015-04-07T04:09:22Z **PR** `#22395`_: (*twangboy*) Fixed problem with pip not working on portable install
...
- 2015-04-06T15:11:34Z **PR** `#22379`_: (*anlutro*) Improve output when using iptables.save
...
- 2015-04-06T14:01:26Z **PR** `#22365`_: (*s0undt3ch*) Include `unless` in the state internal keywords.
  | refs: `#22621`_
...
- 2015-04-05T22:15:43Z **PR** `#22374`_: (*anlutro*) Corrected output for iptables rule saved to file
...
- 2015-04-05T19:57:39Z **PR** `#22372`_: (*anlutro*) iptables needs `-m state` for `--state` arguments
...
- 2015-04-05T15:57:55Z **PR** `#22368`_: (*anlutro*) Make iptables module build_rules accept protocol as an alias for proto
...
- 2015-04-04T02:03:32Z **PR** `#22349`_: (*cro*) Backport 22005 to 2014.7
...
- 2015-04-03T22:34:02Z **PR** `#22345`_: (*rallytime*) Document list_node* functions for salt cloud
...
- 2015-04-03T21:47:21Z **PR** `#22341`_: (*basepi*) [2014.7] Fix some salt-ssh issues with Fedora 21
...
- 2015-04-03T20:13:48Z **PR** `#22337`_: (*rallytime*) Backport `#22245`_ to 2014.7
...
- 2015-04-03T13:09:29Z **PR** `#22311`_: (*twangboy*) Win install
...
- 2015-04-02T23:45:38Z **PR** `#22300`_: (*rallytime*) Add windows package installers to docs

  * 4281cd6 Merge pull request `#22300`_ from rallytime/windows_release_docs
  * 1abaacd Add windows package installers to docs

- 2015-04-02T23:21:19Z **PR** `#22308`_: (*whiteinge*) Better explanations and more examples of how the Reactor calls functions
...
- 2015-04-02T18:59:31Z **PR** `#22266`_: (*twangboy*) Win install fix
...
- 2015-04-02T18:52:38Z **PR** `#22288`_: (*nshalman*) SmartOS Esky: pkgsrc 2014Q4 Build Environment
...
- 2015-04-02T15:28:34Z **PR** `#22280`_: (*s0undt3ch*) Don't pass `ex_config_drive` to libcloud unless it's explicitly enabled
...
- 2015-04-01T19:02:13Z **PR** `#22256`_: (*twangboy*) Fixed pip.install for windows

  * 5129f21 Merge pull request `#22256`_ from twangboy/fix_pip_install
  * 3792ea1 Fixed pip.install for windows

- 2015-04-01T16:41:10Z **PR** `#22126`_: (*s0undt3ch*) Update environment variables.

  * 3001b72 Merge pull request `#22126`_ from s0undt3ch/2014.7
  * 9649339 Update environment variables.

- 2015-04-01T16:37:17Z **PR** `#22025`_: (*tjstansell*) fix `#21397`_ - force glibc to re-read resolv.conf
...
- 2015-04-01T15:16:28Z **PR** `#22235`_: (*dhs-rec*) Possible fix for 'puppet.run always returns 0 `#20850`_'
...
- 2015-04-01T14:59:38Z **PR** `#22206`_: (*s0undt3ch*) more pylint disables
...
- 2015-04-01T14:08:05Z **PR** `#22222`_: (*twangboy*) Fixed problem with nested directories

  * 9ab3d5e Merge pull request `#22222`_ from twangboy/fix_installer
  * 8615e8d Fixed problem with nested directories

- 2015-04-01T03:56:23Z **PR** `#22228`_: (*garethgreenaway*) backporting `#22226`_ to 2014.7
...
- 2015-03-31T20:59:23Z **PR** `#22205`_: (*twangboy*) Removed _tkinter.lib

  * 8b726e3 Merge pull request `#22205`_ from twangboy/win_install
  * 8644383 Removed _tkinter.lib

- 2015-03-31T12:14:01Z **PR** `#22183`_: (*s0undt3ch*) Disable PEP8 E402(E8402). Module level import not at top of file.
...
- 2015-03-30T22:45:19Z **PR** `#22168`_: (*semarj*) fix cas behavior on data module
...
- 2015-03-30T19:49:35Z **PR** `#22161`_: (*rallytime*) Backport `#21959`_ to 2014.7
...
- 2015-03-30T19:49:20Z **PR** `#22160`_: (*rallytime*) Backport `#22134`_ to 2014.7
...
- 2015-03-30T18:25:52Z **PR** `#22156`_: (*amendlik*) Fix arguments passed to chef-solo command
...
- 2015-03-30T16:27:42Z **PR** `#22121`_: (*tjstansell*) fix `#20841`_: add sls name from reactor
...
- 2015-03-30T16:06:23Z **PR** `#22122`_: (*tjstansell*) backport `#20166`_ to 2014.7
