...
- 2015-03-25T19:08:31Z **PR** `#22002`_: (*basepi*) [2014.7] Backport `#21703`_
...
- 2015-03-25T17:50:22Z **PR** `#21994`_: (*twangboy*) Used WMI to detect real osversion in Windows
...
- 2015-03-25T14:41:21Z **PR** `#21974`_: (*tjstansell*) fixes `#21952`_ - only read ssh host_key header for legacy binary format
...
- 2015-03-25T14:40:45Z **PR** `#21972`_: (*tjstansell*) fix `#21971`_ - ssh_host_key.pub should return as key.pub not key.pub.pub
...
- 2015-03-25T04:03:09Z **PR** `#21968`_: (*ryanwohara*) Verifying the key has a value before using it.

  * b409209 Merge pull request `#21968`_ from ryanwohara/2014.7
  * cbb09b0 Verifying the key has a value before using it.

- 2015-03-25T04:02:11Z **PR** `#21962`_: (*rallytime*) Apply nested outputter optimization fix to 2014.7
...
- 2015-03-25T01:27:47Z **PR** `#21965`_: (*basepi*) [2014.7] Catch msgpack error in file.recurse in salt-ssh
...
- 2015-03-24T23:32:25Z **PR** `#21963`_: (*cachedout*) Release note changes

  * cda629d Merge pull request `#21963`_ from cachedout/2014_7_3_changes
  * 2639f4b Release note changes

- 2015-03-24T23:19:58Z **PR** `#21944`_: (*cachedout*) Prevent multi-master from dying with pillar refresh error
...
- 2015-03-24T22:45:40Z **PR** `#21955`_: (*rallytime*) Add default for pillar_source_merging_strategy in conf/master file
...
- 2015-03-24T21:50:24Z **PR** `#21957`_: (*cachedout*) 2014.7.3 release notes

  * 16fbfa3 Merge pull request `#21957`_ from cachedout/2014_7_3_release_notes
  * e6d7062 2014.7.3 release notes

- 2015-03-24T20:16:19Z **PR** `#21946`_: (*cro*) Clarify how defaults are indicated in the config files.
...
- 2015-03-24T18:25:02Z **PR** `#21941`_: (*thatch45*) Add a seperate loader base name path to multimaster
...
- 2015-03-24T03:37:53Z **PR** `#21926`_: (*jfindlay*) fix network.iface module related stack traces

  * 278d293 Merge pull request `#21926`_ from jfindlay/fix_net
  * a16039c fix network.iface module related stack traces

- 2015-03-24T01:25:54Z **PR** `#21921`_: (*jfindlay*) config gate net.arp on presence of arp

  * d3e14e5 Merge pull request `#21921`_ from jfindlay/net_arp
  * 958bf09 config gate net.arp on presence of arp

- 2015-03-24T01:22:22Z **PR** `#21811`_: (*jacksontj*) Re-work timeouts in saltnado
...
- 2015-03-24T01:19:07Z **PR** `#21918`_: (*rallytime*) Backport `#21885`_ to 2014.7
...
- 2015-03-23T21:56:03Z **PR** `#21901`_: (*cachedout*) Deep copy opts

  * e07220d Merge pull request `#21901`_ from cachedout/deepcopy_opts
  * 3a5f36d Deep copy opts

- 2015-03-21T17:04:30Z **PR** `#21872`_: (*borgstrom*) Remove _locals from the final exec call in pyobjects (2014.7)
...
- 2015-03-20T20:19:32Z **PR** `#21861`_: (*twangboy*) Final (hopefully) improvements to the new build structure
...
- 2015-03-20T19:44:24Z **PR** `#21854`_: (*jfindlay*) backport `#21791`_ to 2014.7
...
- 2015-03-20T19:23:00Z **PR** `#21857`_: (*jfindlay*) backport `#21844`_ to 2014.7
...
- 2015-03-20T19:15:33Z **PR** `#21855`_: (*rallytime*) Backport `#21841`_ to 2014.7
...
- 2015-03-20T18:56:31Z **PR** `#21851`_: (*rallytime*) Backport the fix in `#20781`_ manually to the 2014.7 branch
...
- 2015-03-20T18:35:31Z **PR** `#21852`_: (*jfindlay*) backport `#21790`_ to 2014.7
...
- 2015-03-20T17:36:21Z **PR** `#21848`_: (*rallytime*) Backport `#21635`_ to 2014.7
...
- 2015-03-20T17:36:02Z **PR** `#21849`_: (*basepi*) [2014.7] saltutil.runner fixes
...
- 2015-03-20T16:35:01Z **PR** `#21846`_: (*rallytime*) Backport `#21795`_ to 2014.7
...
- 2015-03-20T16:34:51Z **PR** `#21847`_: (*rallytime*) Backport `#21832`_ to 2014.7
...
- 2015-03-20T16:25:58Z **PR** `#21826`_: (*jfindlay*) propagate original IOError message through file.manage_file
...
- 2015-03-19T22:00:35Z **PR** `#21828`_: (*basepi*) [2014.7] Append `#21818`_
...
- 2015-03-19T21:36:17Z **PR** `#21821`_: (*basepi*) [2014.7] Backport `#21813`_ to 2014.7
...
- 2015-03-19T20:39:21Z **PR** `#21822`_: (*basepi*) [2014.7] Backport `#21820`_ to 2014.7
...
- 2015-03-19T19:24:23Z **PR** `#21818`_: (*basepi*) [2014.7] Backport `#21781`_ to 2014.7
  | refs: `#21828`_
...
- 2015-03-19T07:39:52Z **PR** `#21786`_: (*rallytime*) Backport `#21739`_ to 2014.7
...
- 2015-03-19T07:38:57Z **PR** `#21785`_: (*rallytime*) Backport `#21738`_ to 2014.7
...
- 2015-03-18T23:04:36Z **PR** `#21780`_: (*cachedout*) Backport `#21775`_ to 2014.7
...
- 2015-03-18T22:21:08Z **PR** `#21782`_: (*rallytime*) Update syndic documentation
...
- 2015-03-18T17:49:38Z **PR** `#21755`_: (*jacksontj*) Add timeout to saltnado's event listener
  | refs: `#21811`_
...
- 2015-03-18T15:39:33Z **PR** `#21757`_: (*jfindlay*) Tar tests
...
- 2015-03-17T23:51:18Z **PR** `#21743`_: (*jfindlay*) add eauth pam group tests
...
- 2015-03-17T18:50:09Z **PR** `#21734`_: (*MrMarvin*) "fixes" bug when parsing interfaces
...
- 2015-03-16T23:30:44Z **PR** `#21701`_: (*rvstaveren*) Fix ldap group handling for 2014.7
...
- 2015-03-16T22:00:51Z **PR** `#21711`_: (*rallytime*) Backport `#21676`_ to 2014.7
...
- 2015-03-16T21:48:52Z **PR** `#21708`_: (*rallytime*) Backport `#21666`_ to 2014.7
...
- 2015-03-16T20:26:31Z **PR** `#21630`_: (*UtahDave*) WORK IN PROGRESS - Fix syndic
...
- 2015-03-16T18:35:47Z **PR** `#21677`_: (*aneeshusa*) Check response status when using fileclient.get_url.
...
- 2015-03-15T18:54:20Z **PR** `#21658`_: (*rvstaveren*) enable eauth during cli batch operations
...
- 2015-03-13T22:29:17Z **PR** `#21648`_: (*tjstansell*) fix `#21628`_: support STP option in rh_ip to enable/disable spanning tree
...
- 2015-03-13T22:28:14Z **PR** `#21636`_: (*basepi*) Gate salt.utils.cloud (imports msgpack) in config.py for salt-ssh
...
- 2015-03-13T22:26:40Z **PR** `#21626`_: (*rallytime*) Backport `#21622`_ to 2014.7
...
- 2015-03-13T21:16:07Z **PR** `#21645`_: (*rallytime*) Set the vm_ password before calling salt.utils.bootstrap
...
- 2015-03-13T20:15:11Z **PR** `#21637`_: (*highlyunavailable*) Increase the timeout of boto route53 module
...
- 2015-03-13T17:56:10Z **PR** `#21632`_: (*rallytime*) Add minimum version dependency for linode-python in docs
...
- 2015-03-13T17:55:37Z **PR** `#21631`_: (*cro*) Remove linodepy.py in favor of linode.py.

  * cfd8173 Merge pull request `#21631`_ from cro/remove_linodepy
  * 47a9459 Remove linodepy.py in favor of linode.py

- 2015-03-13T15:23:41Z **PR** `#21621`_: (*tjstansell*) fixed `#21620`_ so delay: 0 works correctly for network.managed interfaces
...
- 2015-03-13T15:15:33Z **PR** `#21605`_: (*highlyunavailable*) Fix tar state options
...
- 2015-03-13T15:15:16Z **PR** `#21593`_: (*jfindlay*) add 802.3ad to debian_ip tunnel modes
...
- 2015-03-12T20:10:47Z **PR** `#21600`_: (*eliasp*) Fix parsing of NTP servers on Windows.
...
- 2015-03-12T16:14:16Z **PR** `#21544`_: (*RobertFach*) fix blockdev.tune issue, where blockdev.tune doesn't report changes for ...
...
- 2015-03-12T15:56:57Z **PR** `#21587`_: (*RobertFach*) Fix 21546 blockdev tune state change issue
...
- 2015-03-12T00:36:47Z **PR** `#21568`_: (*jfindlay*) Don't obfuscate internal distutils attributes
...
- 2015-03-11T21:05:57Z **PR** `#21514`_: (*rallytime*) Apply fix from `#21489`_ to the 2014.7 branch
...
- 2015-03-11T21:05:43Z **PR** `#21562`_: (*cro*) Backport 21283 from develop.
...
- 2015-03-11T21:05:08Z **PR** `#21487`_: (*rallytime*) Backport `#21469`_ to 2014.7
...
- 2015-03-11T20:36:36Z **PR** `#21559`_: (*s0undt3ch*) Don't obfuscate the internal version attribute
  | refs: `#21568`_
...
- 2015-03-11T20:27:18Z **PR** `#21557`_: (*s0undt3ch*) [2014.7] Update the bootstrap script to latest stable, v2015.03.15
...
- 2015-03-11T20:21:33Z **PR** `#21523`_: (*jfindlay*) backport `#21481`_ to 2014.7
...
- 2015-03-11T20:21:18Z **PR** `#21555`_: (*ross-p*) Fix for issue `#21491`_
...
- 2015-03-11T20:20:12Z **PR** `#21564`_: (*eliasp*) Typo (rendered → renderer)

  * 8cd4849 Merge pull request `#21564`_ from eliasp/patch-1
  * bc9a30b Typo (rendered â renderer)

- 2015-03-11T18:12:19Z **PR** `#21551`_: (*robgott*) updated s3.query function to return headers for successful requests
...
- 2015-03-11T17:45:15Z **PR** `#21162`_: (*cro*) Update linode salt-cloud driver to support using either linode-python or apache-libcloud
...
- 2015-03-11T15:17:28Z **PR** `#21536`_: (*eliasp*) Correct typo ('win_update.install' → 'win.update_installed').
...
- 2015-03-10T21:14:31Z **PR** `#21510`_: (*twangboy*) Fixed disable function in win_service.py to actually disable service
...
- 2015-03-10T21:12:30Z **PR** `#21497`_: (*ross-p*) Backport of PR `#21358`_ to 2014.7
...
- 2015-03-10T15:31:39Z **PR** `#21488`_: (*jacobhammons*) Regenerated and updated man pages, updated release version in conf.py to...
...
- 2015-03-09T20:21:48Z **PR** `#21437`_: (*rallytime*) Backport `#21409`_ to 2014.7
...
- 2015-03-09T19:33:00Z **PR** `#21439`_: (*jfindlay*) remove 'master' reference in error message
...
- 2015-03-09T19:27:19Z **PR** `#21432`_: (*eliasp*) Fix `#21304`_ (backport of `#21431`_)
...
- 2015-03-09T16:55:17Z **PR** `#21407`_: (*freimer*) Added status.master capability for Windows
...
- 2015-03-09T16:55:01Z **PR** `#21411`_: (*terminalmage*) Fix file.recurse on root of gitfs/hgfs/svnfs repo
...
- 2015-03-09T16:48:19Z **PR** `#21380`_: (*lorengordon*) Fix logic conflict with `enabled` between service.running and service.dead
...
- 2015-03-07T01:38:00Z **PR** `#21395`_: (*jacksontj*) Backport fix for `#20494`_
...
- 2015-03-07T00:27:33Z **PR** `#21355`_: (*The-Loeki*) Fix for comments containing whitespaces
...
- 2015-03-07T00:27:14Z **PR** `#21373`_: (*hvnsweeting*) bugfix: fix test mode in ssh_known_hosts

  * 3736c89 Merge pull request `#21373`_ from hvnsweeting/2014.7
  * 2a84598 bugfix: fix test mode in ssh_known_hosts

- 2015-03-06T19:14:26Z **PR** `#21381`_: (*rallytime*) Pylint fix for 2014.7 branch

  * 855d8cf Merge pull request `#21381`_ from rallytime/pylint_seven
  * b9f3b79 Pylint fix for 2014.7 branch

- 2015-03-06T16:01:39Z **PR** `#21374`_: (*sivann*) better grains.virtual through systemd-detect-virt and virt-what, fixes issue `#21218`_
...
- 2015-03-06T15:59:02Z **PR** `#21310`_: (*devweasel*) Fixes for `#21114`_
...
- 2015-03-06T15:56:16Z **PR** `#21346`_: (*MrMarvin*) * fixes states.network bonding for debian
...
- 2015-03-06T15:45:41Z **PR** `#21360`_: (*terminalmage*) Fix traceback in sysctl.present state output
...
- 2015-03-06T15:43:18Z **PR** `#21366`_: (*d--j*) Make debian_ip.get_interface not remove dns-nameservers
...
- 2015-03-04T18:01:03Z **PR** `#21308`_: (*s0undt3ch*) [2014.7] Update the bootstrap script to latest stable v2015.03.04

  * a5a14ff Merge pull request `#21308`_ from s0undt3ch/2014.7
  * 26f07a0 Update the bootstrap script to latest stable v2015.03.04

- 2015-03-04T15:39:48Z **PR** `#21302`_: (*nmadhok*) Adding src folder to .gitignore

  * 0775966 Merge pull request `#21302`_ from nmadhok/add-src-gitignore
  * 67c1c4a Adding src folder to .gitignore

- 2015-03-04T15:36:32Z **PR** `#21269`_: (*RobertFach*) fixed issue which causes mount.mounted to fail when superopts are not pa...
...
- 2015-03-04T06:23:40Z **PR** `#21289`_: (*hvnsweeting*) do not log at error lvl for ssh-keygen check command

  * ce4d97f Merge pull request `#21289`_ from hvnsweeting/2014.7
  * fa10a97 do not log at error lvl for check command

- 2015-03-03T21:13:47Z **PR** `#21275`_: (*terminalmage*) Fix invalid kwarg output

  * da6eb8b Merge pull request `#21275`_ from terminalmage/fix-invalid-kwargs
  * 9e8ce47 Fix invalid kwarg output

- 2015-03-03T16:42:02Z **PR** `#21050`_: (*lorengordon*) Fix file.replace regressions, fixes saltstack`#20970`_ and saltstack`#20603`_
...
- 2015-03-03T16:38:49Z **PR** `#21253`_: (*freimer*) Fix for Python (Win32) without a signal.SIGKILL

  * aa03bac Merge pull request `#21253`_ from freimer/issue_21057_2014.7
  * 580afe7 Fix for Python (Win32) without a signal.SIGKILL

- 2015-03-03T16:37:36Z **PR** `#21242`_: (*jfindlay*) indent quoted code in cmdmod tests

  * 8e63572 Merge pull request `#21242`_ from jfindlay/cmd_tests
  * a6b86ef indent quoted code in cmdmod tests

- 2015-03-03T01:02:10Z **PR** `#21182`_: (*ndenev*) Make sure tmp_dir does not end in a slash, and remove extra escapes.

  * 5f3b818 Merge pull request `#21182`_ from ndenev/2014.7
  * d243c36 Merge remote-tracking branch 'upstream/2014.7' into 2014.7

- 2015-03-02T04:06:02Z **PR** `#21200`_: (*UtahDave*) Cherry pick back to 2014.7 branch - convert datetime objects to strings

  * 6577a20 Merge pull request `#21200`_ from UtahDave/2014.7local
  * fc1c17b convert datetime objects to strings

- 2015-03-01T16:40:44Z **PR** `#21179`_: (*whiteinge*) Improved presence docs; added cross-references and localhost caveat
...
- 2015-02-28T16:24:42Z **PR** `#21125`_: (*jfindlay*) add cmd module integration tests

  * 5bbc21f Merge pull request `#21125`_ from jfindlay/cmd_tests
  * 17b8f73 add cmd module integration tests

- 2015-02-28T16:04:41Z **PR** `#21151`_: (*s0undt3ch*) [2014.7] Update bootstrap script to latest stable, v2015.02.28

  * 36776e7 Merge pull request `#21151`_ from s0undt3ch/2014.7
  * 0e5adac Update bootstrap script to latest stable, v2015.02.28

- 2015-02-27T04:13:44Z **PR** `#21103`_: (*s0undt3ch*) [2014.7] Update the bootstrap script to latest stable v2015.02.27
...
- 2015-02-27T01:10:01Z **PR** `#21095`_: (*jond64*) Fix for `#21039`_
...
- 2015-02-26T18:08:38Z **PR** `#21058`_: (*terminalmage*) Support Chocolatey 0.9.9+
...
- 2015-02-26T18:07:54Z **PR** `#21070`_: (*RobertFach*) fixed issue where user option is internally transformed to username whic...
...
- 2015-02-26T17:49:00Z **PR** `#21076`_: (*RobertFach*) fixed invalid changes data issue
...
- 2015-02-26T17:48:41Z **PR** `#21077`_: (*terminalmage*) Add missing function config.gather_bootstrap_script
...
- 2015-02-26T16:29:01Z **PR** `#21069`_: (*RobertFach*) added options auto, users to mount invisible options
...
- 2015-02-26T16:20:09Z **PR** `#21063`_: (*jond64*) Backport `#16306`_ to 2014.7
...
- 2015-02-26T02:58:34Z **PR** `#21052`_: (*lorengordon*) Convert `pattern` to string, fixes saltstack`#21051`_
...
- 2015-02-26T01:09:17Z **PR** `#20854`_: (*terminalmage*) VCS fileserver backend fixes/optimizations
...
- 2015-02-26T01:07:00Z **PR** `#21023`_: (*rallytime*) Backport `#19303`_ to 2014.7
...
- 2015-02-26T00:44:02Z **PR** `#21047`_: (*jfindlay*) simplify yaml parsing for publish module
...
- 2015-02-25T23:13:03Z **PR** `#21034`_: (*basepi*) [2014.7] Fix for salt-ssh without command line parsers
...
- 2015-02-25T23:12:16Z **PR** `#21032`_: (*rallytime*) Backport `#21024`_ to 2014.7
...
- 2015-02-25T22:55:29Z **PR** `#21028`_: (*rallytime*) Use LooseVersion instead of StrictVersion to use an RC version of MongoDB
...
- 2015-02-25T17:22:30Z **PR** `#21022`_: (*nitti*) correctly count active devices when creating a mdadm array with spares
...
- 2015-02-25T16:39:33Z **PR** `#20992`_: (*jfindlay*) fix arg preparation for publish module
  | refs: `#21047`_
...
- 2015-02-25T16:36:25Z **PR** `#21002`_: (*rallytime*) Moar digitalocean tests
...
- 2015-02-25T16:14:05Z **PR** `#21013`_: (*wt*) Add version to a deprecation log message.
...
- 2015-02-24T22:32:21Z **PR** `#20984`_: (*rallytime*) Switch modprobe -r to rmmod in kmod.remove
...
- 2015-02-24T22:29:21Z **PR** `#20990`_: (*joehoyle*) Backport fix `#20987`_
...
- 2015-02-24T21:23:15Z **PR** `#20983`_: (*basepi*) [2014.7] Backport `#20304`_ to catch msgpack errors in cmd.run
...
- 2015-02-24T03:04:04Z **PR** `#20957`_: (*jfindlay*) adding cmd.run integration tests

  * 00e3dc3 Merge pull request `#20957`_ from jfindlay/cmd_tests
  * 5ab5380 adding cmd.run integration tests

- 2015-02-24T02:14:42Z **PR** `#20937`_: (*wt*) Log when the yaml filter outputs trailing ellipsis.
...
- 2015-02-24T02:02:00Z **PR** `#20954`_: (*rallytime*) Backport `#20891`_ to 2014.7
...
- 2015-02-24T00:01:01Z **PR** `#20953`_: (*rallytime*) Backport `#20888`_ to 2014.7
...
- 2015-02-23T23:44:08Z **PR** `#20951`_: (*rallytime*) Backport `#20837`_ to 2014.7
...
- 2015-02-23T15:35:02Z **PR** `#20922`_: (*bbinet*) 2014.7: fix issue 20921
...
- 2015-02-21T14:02:48Z **PR** `#20895`_: (*bechtoldt*) fix wrong dict access in smtp returner in 2014.7
...
- 2015-02-21T00:47:34Z **PR** `#20880`_: (*thatch45*) fix bug from systems without any legacy init scripts
...
- 2015-02-21T00:41:17Z **PR** `#20881`_: (*thatch45*) Remove requisites from listen post calls
...
- 2015-02-20T23:58:33Z **PR** `#20856`_: (*jrgp*) Don't remount loop back filesystems upon every state run
...
- 2015-02-20T20:37:23Z **PR** `#20866`_: (*terminalmage*) Update the RHEL installation guide
...
- 2015-02-20T01:29:00Z **PR** `#20848`_: (*rallytime*) Integration tests for the new requisites added in 2014.7
...
- 2015-02-19T23:43:50Z **PR** `#20847`_: (*rallytime*) Add listen and listen_in to state internal kwargs

  * c9b766c Merge pull request `#20847`_ from rallytime/state_kwargs
  * 5d22cba Add listen and listen_in to state internal kwargs

- 2015-02-19T20:07:45Z **PR** `#20839`_: (*rallytime*) Backport `#20608`_ to 2014.7
...
- 2015-02-19T20:06:07Z **PR** `#20842`_: (*thatch45*) Add requisite ins to state internal kwargs

  * 2ef28c7 Merge pull request `#20842`_ from thatch45/state_kwargs
  * 97cda22 Add requisite ins to state internal kwargs

- 2015-02-19T17:41:24Z **PR** `#20834`_: (*peresadam*) Fixed dict unpacking in salt.utils.format_call
...
- 2015-02-19T17:40:24Z **PR** `#20831`_: (*RobertFach*) added nointr invisible mount option
...
- 2015-02-19T17:15:17Z **PR** `#20613`_: (*jfindlay*) change incorrect 'text' outputter to 'txt'
...
- 2015-02-18T23:25:46Z **PR** `#20813`_: (*rallytime*) Update Arch installation docs to reference salt-zmq and salt-raet pkgs
...
- 2015-02-18T21:54:47Z **PR** `#20810`_: (*rallytime*) Add 2014.7.2 package links to the windows installer docs
...
- 2015-02-18T17:59:31Z **PR** `#20800`_: (*rallytime*) Backport `#20768`_ to 2014.7
...
- 2015-02-18T00:38:32Z **PR** `#20778`_: (*terminalmage*) Add Synology OS detection
...
- 2015-02-17T20:01:39Z **PR** `#20762`_: (*jfindlay*) fix nftables.get_rule_handle return error
...
- 2015-02-17T19:36:10Z **PR** `#20765`_: (*rallytime*) Backport `#20706`_ to 2014.7
...
- 2015-02-17T19:31:17Z **PR** `#20739`_: (*mikn*) Giving publish.publish more robust return handling
...
- 2015-02-17T04:58:43Z **PR** `#20689`_: (*rallytime*) Backport `#20457`_ to 2014.7
...
- 2015-02-14T00:46:25Z **PR** `#20697`_: (*whiteinge*) Add note to rest_cherrypy instructions: restarting daemons is required
...
- 2015-02-13T18:21:15Z **PR** `#20684`_: (*rallytime*) Backport `#20232`_ to 2014.7
...
- 2015-02-13T16:16:28Z **PR** `#20682`_: (*rallytime*) Add dependency notice to proxmox.rst
...
- 2015-02-13T00:39:31Z **PR** `#20671`_: (*whiteinge*) Reactor docs updates
...
- 2015-02-12T19:53:01Z **PR** `#20641`_: (*whiteinge*) Updated the event docs with the current Python API and more examples
...
- 2015-02-12T18:44:29Z **PR** `#20640`_: (*rallytime*) Change the release notes title to 2014.7.2
...
- 2015-02-12T18:11:14Z **PR** `#20633`_: (*sbrandtb*) Fixed wrong placement of speechmarks

  * f79108b Merge pull request `#20633`_ from sbrandtb/fix_locale_speechmarks
  * 2fdb798 Fixed wrong placement of speechmarks

- 2015-02-12T17:38:53Z **PR** `#20616`_: (*rallytime*) Merge `#20419`_ with test syntax fix
...
- 2015-02-11T22:07:41Z **PR** `#20604`_: (*basepi*) [2014.7] Accept kali linux for aptpkg.py
...
- 2015-02-11T18:46:10Z **PR** `#20591`_: (*rallytime*) Backport `#20568`_ to 2014.7
...
- 2015-02-11T03:51:23Z **PR** `#20578`_: (*rallytime*) Backport `#20561`_ to 2014.7
...
- 2015-02-11T02:56:23Z **PR** `#20579`_: (*rallytime*) Backport `#20567`_ to 2014.7
...
- 2015-02-10T19:44:21Z **PR** `#20509`_: (*bechtoldt*) fix broken ipv6 address verification in salt.utils.validate.net, fixes `#20508`_
...
- 2015-02-10T17:00:05Z **PR** `#20500`_: (*eliasp*) Use same string encoding for results from all fileserver backends.
...
- 2015-02-10T01:34:10Z **PR** `#20534`_: (*rallytime*) Backport `#20454`_ to 2014.7
...
- 2015-02-10T01:32:01Z **PR** `#20533`_: (*rallytime*) Backport `#20521`_ to 2014.7
