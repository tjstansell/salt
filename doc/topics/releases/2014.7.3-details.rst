...
- **PR** `#21703`_: (*basepi*) [2015.2] Catch TypeErrors from cmd.run jid_file functionality in salt-ssh *( references: `#21657`_ )*
...
- **PR** `#21994`_: (*twangboy*) Used WMI to detect real osversion in Windows *( references: `#15051`_ )*
...
- **PR** `#21962`_: (*rallytime*) Apply nested outputter optimization fix to 2014.7 *( references: `#21920`_ )*
...
- **PR** `#21965`_: (*basepi*) [2014.7] Catch msgpack error in file.recurse in salt-ssh *( references: `#21922`_ )*
...
- **PR** `#21955`_: (*rallytime*) Add default for pillar_source_merging_strategy in conf/master file *( references: `#21511`_ )*
...
- **PR** `#21755`_: (*jacksontj*) Add timeout to saltnado's event listener *( references: `#21707`_ )*
...
- **PR** `#21844`_: (*johanek*) Always check other OS release files if lsb_distrib_id grain not populated from /etc/lsb-release *( references: `#19953`_ )*
...
- **PR** `#20781`_: (*cachedout*) Don't float exceptions on auth errors in mine *( references: `#20735`_ )*
...
- **PR** `#21635`_: (*jfindlay*) check for ssh key comment *( references: `#21603`_ )*
...
- **PR** `#21849`_: (*basepi*) [2014.7] saltutil.runner fixes *( references: `#21650`_ )*
...
- **PR** `#21846`_: (*rallytime*) Backport `#21795`_ to 2014.7 *( references: `#20197`_ )*
- **PR** `#21795`_: (*cachedout*) Avoid dueling opts with fileclients in highstate *( references: `#19932`_ )*
...
- **PR** `#15848`_: (*cachedout*) Re-inject opts into modules under multi-master mode. *( references: `#13944`_ )*
...
- **PR** `#21826`_: (*jfindlay*) propagate original IOError message through file.manage_file *( references: `#21774`_ )*
...
- **PR** `#21781`_: (*basepi*) [2015.2] Fix syndic pushing load to master of masters *( references: `#21495`_ )*
...
- **PR** `#21780`_: (*cachedout*) Backport `#21775`_ to 2014.7 *( references: `#21775`_ )*
...
- **ISSUE** `#19864`_: (*claudiupopescu*) Salt syndic architecture is slow
- **PR** `#21782`_: (*rallytime*) Update syndic documentation *( references: `#19864`_ )*
...
- **PR** `#21743`_: (*jfindlay*) add eauth pam group tests *( references: `#17380`_ )*
...
- **PR** `#21734`_: (*MrMarvin*) "fixes" bug when parsing interfaces *( references: `#19405`_ )*
...
- **PR** `#21701`_: (*rvstaveren*) Fix ldap group handling for 2014.7 *( references: `#21661`_ )*
...
- **PR** `#21666`_: (*ahus1*) RVM doesn't install as non-root, gems don't install for RVM *( references: `#6815`_ `#20317`_ )*
...
- **PR** `#21677`_: (*aneeshusa*) Check response status when using fileclient.get_url. *( references: `#21625`_ )*
...
- **PR** `#21636`_: (*basepi*) Gate salt.utils.cloud (imports msgpack) in config.py for salt-ssh *( references: `#21226`_ )*
...
- **PR** `#21622`_: (*aneeshusa*) Teach file.check_perms to handle uids and gids. *( references: `#21423`_ )*
...
- **PR** `#21605`_: (*highlyunavailable*) Fix tar state options *( references: `#20795`_ )*

  * 133318f Fix tar state options

dc4e90f Merge pull request `#21593`_ from jfindlay/deb_ip_mode

- **PR** `#21593`_: (*jfindlay*) add 802.3ad to debian_ip tunnel modes *( references: `#21239`_ )*
...
- **PR** `#21559`_: (*s0undt3ch*) Don't obfuscate the internal version attribute *( references: `#21522`_ )*
...
- **PR** `#21489`_: (*pruiz*) Fix `#20787`_: YamlEx pillar merging fails when using gpg (even if pillar_source_merging_strategy is set to aggregate) *( references: `#20787`_ )*
...
- **PR** `#21283`_: (*gtmanfred*) Fix openstack cloud driver to work with only bootstrapping *( references: `#20932`_ )*
...
- **PR** `#21557`_: (*s0undt3ch*) [2014.7] Update the bootstrap script to latest stable, v2015.03.15 *( references: `#555`_ )*
...
- **PR** `#21481`_: (*opdude*) Fixed an error with SIGKILL on windows *( references: `#21244`_ )*
- **PR** `#21244`_: (*freimer*) Fix for Python without a signal.SIGKILL (Win32) *( references: `#21057`_ )*
...
- **PR** `#21555`_: (*ross-p*) Fix for issue `#21491`_ *( references: `#21553`_ )*
...
- **PR** `#21358`_: (*ross-p*) Fix composer, issue `#21349`_ *( references: `#21349`_ )*
...
- **PR** `#21439`_: (*jfindlay*) remove 'master' reference in error message *( references: `#21301`_ )*
...
- **PR** `#21411`_: (*terminalmage*) Fix file.recurse on root of gitfs/hgfs/svnfs repo *( references: `#20812`_ )*
...
- **PR** `#21380`_: (*lorengordon*) Fix logic conflict with `enabled` between service.running and service.dead *( references: `#20915`_ )*
...
- **PR** `#21395`_: (*jacksontj*) Backport fix for `#20494`_ *( references: `#20494`_ )*
...
- **PR** `#21360`_: (*terminalmage*) Fix traceback in sysctl.present state output *( references: `#21300`_ )*
...
- **PR** `#21366`_: (*d--j*) Make debian_ip.get_interface not remove dns-nameservers *( references: `#18318`_ )*
...
- **PR** `#21050`_: (*lorengordon*) Fix file.replace regressions, fixes saltstack`#20970`_ and saltstack`#20603`_ *( references: `#18612`_ )*
...
- **PR** `#21179`_: (*whiteinge*) Improved presence docs; added cross-references and localhost caveat *( references: `#18436`_ )*
...
- **PR** `#21103`_: (*s0undt3ch*) [2014.7] Update the bootstrap script to latest stable v2015.02.27 *( references: `#533`_ )*
- **PR** `#533`_: (*syphernl*) Only load nginx on machines that have nginx installed *( references: `#496`_ )*
...
- **PR** `#20854`_: (*terminalmage*) VCS fileserver backend fixes/optimizations *( references: `#20785`_ `#17945`_ `#20896`_ `#20993`_ `#21021`_ )*
- **PR** `#20141`_: (*crasu*) Fix file locking for gitfs see `#18839`_ *( references: `#18839`_ )*
...
- **PR** `#19303`_: (*cachedout*) Batch ckminions *( references: `#18358`_ )*
...
- **PR** `#21034`_: (*basepi*) [2014.7] Fix for salt-ssh without command line parsers *( references: `#20418`_ )*
...
- **PR** `#20990`_: (*joehoyle*) Backport fix `#20987`_ *( references: `#20987`_ )*
...
- **PR** `#20304`_: (*basepi*) [2015.2] Catch msgpack errors from cmd.run for salt-ssh *( references: `#20276`_ )*
...
- **PR** `#20922`_: (*bbinet*) 2014.7: fix issue 20921 *( references: `#20921`_ )*
...
- **PR** `#20881`_: (*thatch45*) Remove requisites from listen post calls *( references: `#20863`_ )*
...
- **PR** `#20856`_: (*jrgp*) Don't remount loop back filesystems upon every state run *( references: `#20855`_ )*
...
- **PR** `#20866`_: (*terminalmage*) Update the RHEL installation guide *( references: `#20742`_ )*
...
- **PR** `#20613`_: (*jfindlay*) change incorrect 'text' outputter to 'txt' *( references: `#20612`_ )*
...
- **PR** `#20778`_: (*terminalmage*) Add Synology OS detection *( references: `#18943`_ )*
...
- **PR** `#20762`_: (*jfindlay*) fix nftables.get_rule_handle return error *( references: `#20747`_ )*
...
- **PR** `#20739`_: (*mikn*) Giving publish.publish more robust return handling *( references: `#16510`_ )*
...
- **PR** `#20232`_: (*jacksontj*) Remove unecessary finish() calls *( references: `#20221`_ )*
...
- **PR** `#20682`_: (*rallytime*) Add dependency notice to proxmox.rst *( references: `#14799`_ )*
...
- **PR** `#20604`_: (*basepi*) [2014.7] Accept kali linux for aptpkg.py *( references: `#20552`_ )*
...
- **PR** `#20500`_: (*eliasp*) Use same string encoding for results from all fileserver backends. *( references: `#20499`_ )*
